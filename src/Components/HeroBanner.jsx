            ...
            <Container>
                <div className="px-2 md:px-0">
                    <div className="text-center pt-16">
                        <h1 className="text-3xl md:text-5xl font-bold mb-2">We Build</h1>
                        <h1 className="text-3xl md:text-5xl font-bold"><span className="bg-gradient-to-r from-[#632EE3] to-[#9F62F2] bg-clip-text text-transparent">Productive</span> Apps</h1>
                        <p className="text-gray-600 py-4 lg:px-72">At HERO.IO, we craft innovative apps designed to make everyday life simpler, smarter, and more exciting.Our goal is to turn your ideas into digital experiences that truly make an impact.</p>
                    </div>

                    {/* Hero button */}
                    <div className="flex gap-4 md:gap-12 justify-center py-3">
                    ...
                    <div className="flex justify-center mt-4">
                        <img className="h-[200px] md:h-[300px]" src={heroLogo} alt="Hero-logo-img" />
                    </div>
                </div>
            </Container>
